...
public static class LocalePackStore
{
    ...
    [
        new() { UiCulture = "en", DisplayName = "English", GameLanguage = "english", InnoLanguage = "english", Revision = 6 },
        new() { UiCulture = "de", DisplayName = "Deutsch", GameLanguage = "german", InnoLanguage = "german", Revision = 6 },
        new() { UiCulture = "fr", DisplayName = "Français", GameLanguage = "french", InnoLanguage = "french", Revision = 6 },
        new() { UiCulture = "es", DisplayName = "Español", GameLanguage = "spanish", InnoLanguage = "spanish", Revision = 6 },
        new() { UiCulture = "pt", DisplayName = "Português", GameLanguage = "portuguese", InnoLanguage = "portuguese", Revision = 6 },
        new() { UiCulture = "pt-BR", DisplayName = "Português (Brasil)", GameLanguage = "brazilian", InnoLanguage = "brazilianportuguese", Revision = 6 },
        new() { UiCulture = "pl", DisplayName = "Polski", GameLanguage = "polish", InnoLanguage = "polish", Revision = 6 },
        new() { UiCulture = "ru", DisplayName = "Русский", GameLanguage = "russian", InnoLanguage = "russian", Revision = 6 },
        new() { UiCulture = "uk", DisplayName = "Українська", GameLanguage = "ukrainian", InnoLanguage = "ukrainian", Revision = 6 },
        new() { UiCulture = "zh-CN", DisplayName = "简体中文", GameLanguage = "chinese_simplified", InnoLanguage = "chinesesimplified", Revision = 6 },
        new() { UiCulture = "zh-TW", DisplayName = "繁體中文", GameLanguage = "chinese_traditional", InnoLanguage = "chinesetraditional", Revision = 6 },
    ];
}
