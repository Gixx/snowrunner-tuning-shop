...
{
    private static readonly Brush NormalBrush = Freeze(0x10, 0x7C, 0x10);
    private static readonly Brush WarningBrush = Freeze(0xCA, 0x50, 0x10);
    private static readonly Brush ExtremeBrush = Freeze(0xC4, 0x2B, 0x1C);
    private static readonly Brush InvalidBrush = Freeze(0xC4, 0x2B, 0x1C);
    private static readonly Brush IdleBrush = Freeze(0x8A, 0x8A, 0x8A);
    ...
    public Visibility AddedHintVisibility =>
        Axle.HadSteerInBaseline ? Visibility.Collapsed : Visibility.Visible;
    ...
    private Brush _safeRangeBrush = IdleBrush;

    public Brush SafeRangeBrush
    {
        get => _safeRangeBrush;
        private set
        {
